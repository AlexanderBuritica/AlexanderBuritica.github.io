...
function filterPubs(btn, topic) {
  ...
  // hide year headings + their divider when no visible card follows before next heading
  const wpId = 'working-papers';
  ...
  // hide dividers adjacent to hidden content (simple approach: hide all dividers on filter, show on 'all')
