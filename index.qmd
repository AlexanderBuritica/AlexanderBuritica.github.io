...
description-meta: "Academic website of Alexander Buriticá Casanova, agricultural economist working on impact evaluation for CGIAR"
...
```{=html}
<!-- ===== HERO — Field Notes style ===== -->
<section class="hero-fieldnotes">
  <div class="hero-fn-cover">
    <img src="files/images/fieldwork/a16.jpeg" alt="Fieldwork" class="hero-fn-cover-img">
  </div>
  <div class="hero-fn-band">
    <div class="hero-fn-card">

      <!-- LEFT: Name + meta + bio + icons -->
      <div class="hero-fn-left">
        <span class="hero-fn-stamp">Postdoctoral Researcher</span>
        <h1 class="hero-fn-name">Alexander Buriticá Casanova</h1>
        <p class="hero-fn-aff">
          <i class="fa-solid fa-location-dot"></i> Cali, Colombia
        </p>

        <div class="hero-fn-bio">
          <p>
            I am a Postdoctoral Researcher in Applied Economics and Impact Evaluation at the Alliance of Bioversity International and CIAT (CGIAR), and hold a PhD in Economics from Universidad de los Andes, Bogotá. My research examines the gap between technology access and welfare outcomes in agriculture, with a focus on impact evaluation, food security, and post-conflict rural development across Latin America and Sub-Saharan Africa. My work has been published in journals including Agricultural Systems, Journal of Rural Studies, and Environmental and Resource Economics, and I have contributed to multi-country research initiatives with CGIAR and international development organizations.
          </p>
        </div>

        <div class="hero-fn-icons">
      ...
      <!-- RIGHT: Circular photo + actions -->
      <div class="hero-fn-right">
