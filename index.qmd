...
<div class="metrics-strip">
  <div class="metric-box">
    ...
    <div class="metric-cap">Peer-reviewed articles</div>
  </div>
  <div class="metric-box">
    <i class="fa-solid fa-quote-right"></i>
    <div class="metric-num">374</div>
    <div class="metric-cap">Citations · h-index 5</div>
  </div>
  <div class="metric-box">
    <i class="fa-solid fa-award"></i>
    <div class="metric-num">3</div>
    <div class="metric-cap">Grants &amp; awards</div>
  </div>
  <div class="metric-box">
    <i class="fa-solid fa-earth-americas"></i>
    <div class="metric-num">4</div>
    <div class="metric-cap">Countries of fieldwork</div>
  </div>
</div>
